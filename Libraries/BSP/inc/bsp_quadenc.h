 ...
 * \brief		Contains all functions to capture the angle. It supports a
 ...
 */
typedef void (*bsp_quadenccallback_t)(void);
 ...
 * ----------------------------------------------------------------------------
 */
#define BSP_QUADENC_INC_PER_TURN	2000		/*!< Number of increments each turn. */
...
static const bsp_gpioconf_t BSP_QUADENC_INCA = {
		RCC_AHB1Periph_GPIOG, GPIOG, GPIO_Pin_8, GPIO_Mode_IN, GPIO_PuPd_NOPULL, GPIO_AF_TIM1
};
...
/* Interrupt settings */
#define BSP_QUADENC_POS_IRQ_CHANEL		TIM1_CC_IRQn		/*!< NVIC timer interrupt */
#define BSP_QUADENC_POS_IRQ_SOURCE		TIM_IT_CC1			/*!< NVIC timer source */
...
#define BSP_QUADENC_I_IRQ_CHANEL		EXTI1_IRQn			/*!< NVIC GPIO interrupt */
#define BSP_QUADENC_I_IRQ_PRIORITY		8					/*!< NVIC GPIO interrupt priority */
#define BSP_QUADENC_I_IRQ_Handler		EXTI1_IRQHandler	/*!< NVIC GPIO handler */
...
extern uint32_t bsp_QuadencGet(void);
